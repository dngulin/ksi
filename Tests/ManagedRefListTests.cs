...
{
    [TestFixture]
    public class ManagedRefListTests
    {
        [TestCase(7)]
        [TestCase(15)]
        [TestCase(32)]
        ...
        {
            var list = ManagedRefList.Empty<int>();
        ...
        {
            var list = ManagedRefList.WithCapacity<int>(count / 2);
            for (var i = 0; i < count; i++)
            {
                list.RefAdd() = i;
                var value = list.Count();
        ...
        {
            var list = ManagedRefList.WithDefaultItems<int>(count);
            for (var i = 0; i < count; i++)
            {
                list.RefAt(i) = -i * 2;
            }
        ...
        public void Move()
        {
            var listA = ManagedRefList.Empty<int>();
            listA.RefAdd() = 42;
