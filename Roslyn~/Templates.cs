namespace DnDev.Roslyn
{
    public static class Templates
    {
        ...
        public static readonly string[] RefListTypes =
        {
            "RefList",
            "NativeRefList",
            "TempRefList",
        ...
        public const string StaticApi = @"// Generated by DnDev.RefList.Roslyn
namespace DnDev
{{
    ...
    {{
        ...
        public const string Extensions = @"// Generated by DnDev.RefList.Roslyn
using System;
...
{{
    ...
    {{
        ...
        public const string Iterators = @"// Generated by DnDev.RefList.Roslyn
using System;
...
{{
    ...
    {{
        ...
        public const string StringExt = @"// Generated by DnDev.RefList.Roslyn
using System;
using System.Text;
...
{{
    ...
    {{
        ...
        public const string RefListCopyToMethod = @"
        public static void CopyTo(this in {0}<{1}> self, ref {0}<{1}> other)
        {{
            other.Clear();
            other.AppendDefault(self.Count);
            other.CopyBufferFrom(self);
        }}";

        public const string RefListDeallocMethod = @"
