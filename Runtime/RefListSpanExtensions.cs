...
namespace Ksi
{
    ...
    public static class RefListSpanExtensions
    {
        ...
        [RefListIterator] public static unsafe ReadOnlySpan<T> AsReadOnlySpan<[ExplicitCopy, Dealloc] T>(this in RefList<T> self)
        ...
        /// <para>Adds to <c>RefPath</c> a non-explicit segment <c>AsReadOnlySpan()</c>.</para>
        /// </summary>
        [RefListIterator] public static unsafe ReadOnlySpan<T> AsReadOnlySpan<[ExplicitCopy, Dealloc, TempAlloc] T>(this in TempRefList<T> self)
            where T : unmanaged => new ReadOnlySpan<T>(self.Array.Buffer, self.Count);
        ...
        [RefListIterator] public static unsafe Span<T> AsSpan<[ExplicitCopy, Dealloc] T>([DynNoResize] this ref RefList<T> self)
        ...
        /// <para>Adds to <c>RefPath</c> a non-explicit segment <c>AsSpan()</c>.</para>
        /// </summary>
        [RefListIterator] public static unsafe Span<T> AsSpan<[ExplicitCopy, Dealloc, TempAlloc] T>([DynNoResize] this ref TempRefList<T> self)
            where T : unmanaged => new Span<T>(self.Array.Buffer, self.Count);
